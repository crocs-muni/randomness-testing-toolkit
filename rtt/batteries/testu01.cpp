...
/* Constant definition */
const std::string TestU01::XPATH_BINARY_PATH =
        "TESTU01_SETTINGS/BINARY_PATH";
const std::string TestU01::XPATH_OUTPUT_FILE =
...
void TestU01::processStoredResults() {
...
posix_spawn_file_actions_t TestU01::createFileActions(
...
void TestU01::readPipes(int *stdout_pipe, int *stderr_pipe) {
...
char ** TestU01::buildArgs(int testNum, int *argc) {
...
void TestU01::destroyArgs(int argc , char ** argv) {
